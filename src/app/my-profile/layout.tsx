...
export default async function layout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            ...
            <main className="w-full h-fit flex py-3 xl:py-10 items-center flex-col px-6 md:px-0">
                <Profile auth_status={auth_status} id={id} />
                <section className="xl:px-10 w-full xl:mt-10 xl:shadow-xl rounded-lg 2xl:w-3/6 xl:w-7/12 md:w-3/4 h-fit flex flex-col gap-5">
