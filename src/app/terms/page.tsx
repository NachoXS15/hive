...
export default function page() {
    return (
        <>
            ...
            <section className="font-second w-full md:w-4/5 xl:w-3/5 px-5 flex flex-col gap-5 m-auto my-15">
                <div className="mb-5">
                    <h1 className="text-center font-bold  font-main mb-5 text-2xl">Términos y Condiciones (12/11/2025).</h1>
                ...
                <div>
                    ...
                    <p>Para utilizar ciertas funciones, el Usuario deberá crear una cuenta proporcionando información veráz y actualizada. El Usuario es responsable de mantener la confidencialidad de sus credenciales y del uso que se haga de su cuenta.</p>
                </div>
                ...
                <div>
                    ...
                    <p>Por cualquier duda o inconviente, contactar a soporte al e-mail: <a href="mailto: hivearg80@gmail.com" className="text-blue-600 hover:underline">hivearg80@gmail.com</a></p>
                </div>
            </section>
            <Footer />
        </>
