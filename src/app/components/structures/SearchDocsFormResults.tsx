...
export default function SearchFormResults({ docs }: Props) {
    ...
    const filteredDocs = useMemo(() => {
        return docs.filter((doc) =>
            ...
            doc.category?.toLocaleLowerCase().includes(category.toLowerCase()) &&
            doc.theme?.toLocaleLowerCase().includes(theme.toLowerCase()) &&
            doc.dept?.toLocaleLowerCase().includes(departamento.toLowerCase()) &&
            doc.degree?.toLocaleLowerCase().includes(carrera.toLowerCase())
        )
