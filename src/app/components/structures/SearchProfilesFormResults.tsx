            ...
            <div className="w-full px-5 md:w-7/12 xl:w-5/12 mt-20">
                <form action="" className="">
                    ...
                    <label htmlFor="" className="w-full h-15 rounded-2xl border border-slate-400 bg-slate-50 flex justify-between items-center px-5">
                        <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} name="search" placeholder="Buscar usuarios..." className="w-full text-xl rounded-lg h-1/2 focus:outline-none focus:ring-0" />
                    </label>
                </form>
            </div>
