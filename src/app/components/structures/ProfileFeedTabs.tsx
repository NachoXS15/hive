        ...
        <>
            ...
            <div className="w-full flex items-center">
                <button
                    ...
                    className={`w-1/2 font-bold text-xl py-2 transition rounded-t-lg ${activeTab === "posts"
                ...
                <button
                    ...
                    className={`w-1/2 font-bold text-xl py-2 transition rounded-t-lg ${activeTab === "docs"
                            ? "bg-slate-600 text-white"
                            : "hover:bg-slate-400 hover:text-white"
                        }`}
                >
