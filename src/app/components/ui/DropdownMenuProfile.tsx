                ...
                <nav className="w-full flex flex-col gap-2 p-3 font-medium">
                    {
                        profile?.role == "authenticated" ? (
                            ...
                            <>
                                <Link href="/auth/login" className="flex items-center gap-2 py-2 w-full px-2 rounded hover:text-black-main hover:bg-yellow-main font-medium active:scale-110 transition"><LogIn /> Iniciar sesión</Link>
                                <Link href="/auth/register" className="flex items-center gap-2 py-2 w-full px-2 rounded hover:text-black-main hover:bg-yellow-main font-medium active:scale-110 transition"><UserPlus2 /> Crear cuenta</Link>
                            </>
                        )
                    }
                </nav>
